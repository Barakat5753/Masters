function [All_Data_Cell] = Prepare_All_Data(Input_Path)
            ...
            if exist(File_Name_Test, 'file') == 2
                ...
                for j = 1 : 1 : 9
                    ...
                    if exist(IMU_filename, 'file') == 2
                        ...
                        All_Data_Cell{1}{k}{j} = table2array(readtable(IMU_filename));
                        All_Data_Cell{2}{k}{j} = horzcat(table2array(readtable(Dyn_R_filename)) , table2array(readtable(Dyn_L_filename)) , table2array(readtable(GRF_R_filename)) , table2array(readtable(GRF_L_filename)) );
                    end 
                end
            end  
	end
